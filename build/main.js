...
const SystemRouter = new BaseRouter_1.default().API;
const Logger = new logUtil_1.default("main");
SystemRouter.use("/select", (0, SelectRouter_1.SelectRouter)().API.routes());
SystemRouter.use("/table", (0, TableRouter_1.TableRouter)().API.routes());
// Server Module
